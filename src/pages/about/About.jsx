    ...
    return (
            <div className={styles["about-content"]}>
                ...
                <p className={styles["about-text"]}>
                    ...
                    tweedehands auto&#39;s vaak een ideale keuze, bijvoorbeeld wanneer het openbaar vervoer niet altijd
                    de beste
                    optie is. Alleen heeft niet iedereen de juiste ervaring of know-how om te weten welke auto nou de
                    juiste
                    keuze is.
                ...
                <ul className={styles["about-text"]}>
                    ...
                    <li>
                        <strong>Tijdwinst</strong>: Wij koppelen je direct aan experts en beschikbare auto&#39;s,
                        waardoor
                        je tijd bespaart.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Duurzaamheid</strong>: Door tweedehands auto&#39;s te kiezen, draag je bij aan een
                        duurzamer
